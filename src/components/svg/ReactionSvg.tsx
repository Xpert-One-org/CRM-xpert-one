...
export default function ReactionSvg({
  stroke = 'white',
  fill = 'white',
}: Props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M17 15C17 15 15.5 17 12.5 17C9.5 17 8 15 8 15"
        stroke={stroke}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
