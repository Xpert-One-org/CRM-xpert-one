...
ALTER TABLE "public"."new_table" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."new_table_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
GRANT ALL ON TABLE "public"."new_table" TO "anon";
GRANT ALL ON TABLE "public"."new_table" TO "authenticated";
GRANT ALL ON TABLE "public"."new_table" TO "service_role";



GRANT ALL ON SEQUENCE "public"."new_table_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."new_table_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."new_table_id_seq" TO "service_role";
